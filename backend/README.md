...
## Project Structure
    ...
    ├── testapiautostoryboa_77752  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_77752`
...
2. Clone this repo and `cd testapiautostoryboa_77752`
